...
public class CustomSocketLogger {
	static private CustomSocketHandler mCustomHandler =  null;
	...
	public CustomSocketLogger(String name,String server,int port){
		try{
			mCustomHandler = new CustomSocketHandler(server,port);
